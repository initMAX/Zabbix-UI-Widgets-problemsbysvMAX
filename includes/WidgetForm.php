...
namespace Modules\PBSM\Includes;
...
class WidgetForm extends CWidgetForm {
	...
	public function addFields(): self {
		...
		return $this
			...
			->addField(
				(new CWidgetFieldIntegerBox('counter_font_size', _('Counter font size'), 10, 64))
					->setDefault(18)
			)
			->addField(
				(new CWidgetFieldIntegerBox('cell_padding', _('Cell padding'), 0, 50))
					->setDefault(10)
			);
	}
}
