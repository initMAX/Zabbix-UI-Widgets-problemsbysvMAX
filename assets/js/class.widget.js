...
class PBSM_CWidgetProblemsBySv extends CWidget {
	...
	setContents(response) {
		...
		if (this.getFields().show_type !== PBSM_CWidgetProblemsBySv.SHOW_GROUPS) {
			return;
		}
	...
	hasPadding() {
		return this.getViewMode() === ZBX_WIDGET_VIEW_MODE_NORMAL
			&& this.getFields().show_type !== PBSM_CWidgetProblemsBySv.SHOW_TOTALS;
	}
}
